...
{
    /// <summary>
    ///  Class for testing AttributeCategoryApi
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [TestFixture]
    public class AttributeCategoryApiTests : CommonApi
    {
        private IAttributeCategoryApi instance;
        ...
        {
            base.CommonInit();
            instance = client.AttributeCategory;
            base.CreateSampleDatabaseForTests();

            string path = Constants.AF_ATTRIBUTE_CATEGORY_PATH;
        ...
        /// <summary>
        /// Test an instance of AttributeCategoryApi
        /// </summary>
        [Test]
        public void InstanceTest()
        {
            Assert.IsInstanceOf(typeof(AttributeCategoryApi), instance, "instance is a AttributeCategoryApi");
        }
        ...
        public void GetTest()
        {
            ...
            Assert.IsInstanceOf<PIAttributeCategory>(response, "response is PICategory");
        }
        ...
        {
            string path = Constants.AF_ATTRIBUTE_CATEGORY_PATH;
            PIAttributeCategory category = instance.GetByPath(path, null);
            category.Id = null;
            category.Description = "New attribute category description";
            category.Links = null;
            category.Path = null;
            category.WebId = null;
