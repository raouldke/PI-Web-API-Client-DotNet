...
{
    /// <summary>
    ///  Class for testing AnalysisTemplateApi
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [TestFixture]
    public class AnalysisTemplateApiTests : CommonApi
    {
        private IAnalysisTemplateApi instance;
        ...
        public void Init()
        {
            ...
            base.CommonInit();
            instance = client.AnalysisTemplate;
        ...
        /// <summary>
        /// Test an instance of AnalysisTemplateApi
        /// </summary>
        [Test]
        public void InstanceTest()
        {
            Assert.IsInstanceOf(typeof(AnalysisTemplateApi), instance, "instance is a AnalysisTemplateApi");
        }

        
        /// <summary>
        /// Test CreateFromAnalysis
        /// </summary>
        [Test]
        public void CreateFromAnalysisTest()
        {
            string analysisWebId = client.Analysis.GetByPath(Constants.AF_ANALYSIS_PATH).WebId;
            string name = Constants.AF_ANALYSIS_TEMPLATE_NAME + "2";
            instance.CreateFromAnalysis(analysisWebId, name);
        ...
        public void GetTest()
        {
            ...
            Assert.IsInstanceOf<PIAnalysisTemplate>(response, "response is PIAnalysisTemplate");
        }
